export default {
    ...
    meterlabel: ({ instance }) => ({
        class: [
            ...
            // Colors
            {
                'bg-red-500 dark:bg-red-400': instance?.meter?.strength == 'weak',
                'bg-orange-500 dark:bg-orange-400': instance?.meter?.strength == 'medium',
                'bg-green-500 dark:bg-green-400': instance?.meter?.strength == 'strong'
            },
    ...
    showicon: {
        class: ['absolute top-3 right-2 -mt-2 z-10', 'text-surface-600 dark:text-white/70']
    },
    hideicon: {
        class: ['absolute top-3 right-2 -mt-2 z-10', 'text-surface-600 dark:text-white/70']
    },
