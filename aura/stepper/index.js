    ...
    stepperpanel: {
        ...
        number: ({ context }) => ({
            class: [
                ...
                // Colors (Conditional)
                context.active ? 'text-blue-600' : 'text-surface-900 dark:text-surface-0', // Adjust colors as needed
        ...
        title: ({ context }) => ({
            class: [
                ...
                // Text
                context.active ? 'text-blue-600' : 'text-surface-700 dark:text-surface-0/80',
                'font-medium',
