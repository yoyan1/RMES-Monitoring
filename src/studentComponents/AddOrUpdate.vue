...
async function addData(){
    ...
    if(props.isNew){
        try{
            AddStudentData(tableName, studentData.value)
            visible.value = false
...
<template>
    <Btn label="Student" icon="pi pi-plus" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" @click="openPosition('left')" v-if="isNew"/>
    ...
    <div class="fixed top-0 left-0 right-0 bg-black-500 modal" v-if="visible">
        <Dialog v-model:visible="visible" :header="isNew? 'Add Student' : 'Update Student'" class="overflow-y-auto" :style="{ width: '90rem', maxHeight: '100vh' }" :position="position" :modal="true" :draggable="false">
            <!-- Modal content -->
            <div>
                    <!-- Modal header -->
                            ...
                            <div style="width: 80vh">
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" v-model="studentData.date_of_birth" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-5000" placeholder="date of birth" id="d-birth" />
                                    </div>
                                    <div>
